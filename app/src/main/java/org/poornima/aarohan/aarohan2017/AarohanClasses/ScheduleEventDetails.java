...
public class ScheduleEventDetails {
         ...
         public static void showEventDetails(View view, int position, Context FragmentContext,Context ActivityContext){
                ...
                ((TextView)dilog_view.findViewById(R.id.d_event_category)).setText("Category:-"+ecategory);
                ((TextView)dilog_view.findViewById(R.id.d_event_type)).setText("Type:-"+etype);
                ((TextView)dilog_view.findViewById(R.id.d_event_location)).setText("Location:-"+elocation);
                ((TextView)dilog_view.findViewById(R.id.d_event_date)).setText("Date:-"+edate);
                ((TextView)dilog_view.findViewById(R.id.d_event_time)).setText("Time:-"+etime);
